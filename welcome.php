...
<html lang="en">
  <head>
    ...
    <title>Sign Up Successful! - Tattoo Hub</title>
        ...
        <div class="col-md-6">
          <div class="card shadow-sm">
            <div class="card-body text-center p-5">
              ...
              <h1 class="display-4 mb-4">Sign Up Successful!</h1>
              <p class="lead mb-4">Welcome to Tattoo Hub! Your account has been created successfully.</p>
